...
export default async function PublicPersonaReportPage() {
  ...
  const mutedBlue = "#7c94be"; // Muted Blue for Private Test
  ...
  const getDriveNarrative = (name: string, envPct: number) => {
    ...
    const scripts: Record<string, any> = {
      "Exploration": { 
        base: "You present yourself in public as a person who is constantly seeking new ideas and intellectual growth.", 
  ...
  const calculatePublicData = (data: any) => {
    if (!data) return null;
  ...
  const pub = calculatePublicData(publicRes.data);
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-20 font-sans">
      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        <header className="mb-12 text-center">
          <h1 className="text-4xl font-black uppercase tracking-widest text-slate-800"> Public Persona Report</h1>
        ...
        {pub && (
          <section className="rounded-3xl border-t-8 bg-white shadow-2xl overflow-hidden mb-12" style={{ borderColor: themeColor }}>
            <div className="px-8 py-4 text-white flex justify-between items-center" style={{ backgroundColor: themeColor }}>
              <h2 className="text-xl font-black uppercase tracking-widest">Public Persona Analysis</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-8 border-r border-slate-100 bg-slate-50/50 flex flex-col gap-10">
                {/* 1. Pie Chart */}
                <div>
                  <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-6">Public Persona Drive Composition</h3>
              ...
              <div className="p-8 flex flex-col gap-6">
                <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Public Persona Details</h3>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-16 max-w-4xl mx-auto">
          ...
          {/* MIDDLE: Return to Public Test (Sage Green) */}
          <Link 
          ...
          {/* RIGHT: Start Private Test (Muted Blue) */}
          <Link 
            href="/tests/private-persona" 
            className="w-full sm:w-auto px-8 py-4 text-white rounded-full font-black text-[10px] uppercase tracking-[0.2em] shadow-lg hover:brightness-95 transition-all text-center" 
            style={{ backgroundColor: mutedBlue }}
          >
            Take Private Persona Test
          </Link>
        </div>
      </main>
    </div>
