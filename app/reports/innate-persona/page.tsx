...
import { calculateInnateScores, driveNames } from "@/lib/persona-utils";
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-20 font-sans">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 max-w-4xl mx-auto">
          <Link href="/tests/private-persona" className="px-8 py-5 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest text-center shadow-xl hover:brightness-110 transition-all" style={{ backgroundColor: themeBlue }}>
